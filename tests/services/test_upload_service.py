...
def test_upload_job_success(
    mock_storage_service, upload_service, job_repo, file_repo, cloud_service
):
    user = User(id=1)
    ...
    cloud_service.upload_file.return_value = {
        "id": "external_id",
        "url": "https://dropbox.com/test",
    }
